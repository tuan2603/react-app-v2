                        ...
                        <ul className="nav navbar-nav">
                            ...
                            <li className="menu-item-has-children dropdown">
                                <NavLink to="/" className="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false"> <i className="menu-icon fa fa-laptop"></i>Components</NavLink>
                            ...
                            <li className="menu-item-has-children dropdown">
                                <NavLink to="/" className="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false"> <i className="menu-icon fa fa-table"></i>Tables</NavLink>
                                <ul className="sub-menu children dropdown-menu">
                            ...
                            <li className="menu-item-has-children dropdown">
                                <NavLink to="/" className="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false"> <i className="menu-icon fa fa-th"></i>Forms</NavLink>
                                <ul className="sub-menu children dropdown-menu">
                            ...
                            <li className="menu-item-has-children dropdown">
                                <NavLink to="/" className="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false"> <i className="menu-icon fa fa-tasks"></i>Icons</NavLink>
                                <ul className="sub-menu children dropdown-menu">
                            ...
                            <li className="menu-item-has-children dropdown">
                                <NavLink to="/" className="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false"> <i className="menu-icon fa fa-bar-chart"></i>Charts</NavLink>
                                <ul className="sub-menu children dropdown-menu">
                            ...
                            <li className="menu-item-has-children dropdown">
                                <NavLink to="/" className="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false"> <i className="menu-icon fa fa-area-chart"></i>Maps</NavLink>
                                <ul className="sub-menu children dropdown-menu">
                            ...
                            <li className="menu-item-has-children dropdown">
                                <NavLink to="/" className="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false"> <i className="menu-icon fa fa-glass"></i>Pages</NavLink>
                                <ul className="sub-menu children dropdown-menu">
